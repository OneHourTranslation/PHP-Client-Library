<?php
	...
	$account_id = 269;
	$secret_key = '5a68561984276108fa42d7cffbbf91a5';
	$url = $sandbox;
...
<form method="post" action="<?php echo $url?>/api/1/project/new/" target="resIframe">
	...
	Account ID: <input type="text" name="account_id" value="<?php echo $account_id?>" readonly="readonly"/> <br />
	Secret Key: <input type="text" name="secret_key" value="<?php echo $secret_key?>" readonly="readonly" /><br />
